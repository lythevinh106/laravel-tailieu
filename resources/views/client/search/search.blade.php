...
@section('content')
    ...
    <section class="product-bg position-fixed top-0 start-0  w-100 h-100 z-0" style="">
        ...
        <img src="{{ asset('client/public/images/bg-timkiem.jpg') }}"
                ...
                <div class="main__left">
                    <div class="row px-0 mx-0 flex-wrap">
                        ...
                        <div class=" col-lg-12">
                            ...
                            <div class="accordion left__list-subject mt-2"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            ...
                                            <button class="accordion-button d-flex align-items-center " type="button"
                                                data-bs-toggle="collapse" data-bs-target="#collapseOne{{ $document->id }}"
                                                aria-expanded="true" aria-controls="collapseOne{{ $document->id }}">
                                                <span>{{ $document->name }}</span> <a class="d-inline-block ms-auto">
                                                    <a href={{ $document->doc }}>

                                                        <img src="{{ asset('client/public/images/download.png') }} "
                                                            style="width: 30px; height: 30px;" alt=""></a>

                                                </a>
                                            </button>
                                        </h2>
                                        <div id="collapseOne{{ $document->id }}" class="accordion-collapse collapse "
                                            ...
                                            <div class="detail__subject  px-3" style="">
                                                <a href="" class=" fs-14  d-flex align-items-center"
                                                    ...
                                                    data-bs-target="#exampleModal{{ $document->id }}">
                                            ...
                                            <div class="modal fade " id="exampleModal{{ $document->id }}" tabindex="-1"
                                                aria-labelledby="exampleModal{{ $document->id }}Label" aria-hidden="true">
                                                ...
                                                ">
                                                        <div class="modal-header text-center ">
                                                            <h1 class="modal-title text-uppercase fs-5 fw-bold text-center mx-auto w-100"
                                                                id="exampleModal{{ $document->id }}Label">
                                                                {{ $document->name }}
                                                            </h1>
                                                                            ...
                                                                            <div class="item rounded-2 border-1 px-1 py-2 px-sm-3 py-sm-5 my-1 my-sm-0"
                                                                                ...
                                                                                <div class="item__title  text-uppercase">
                                                                                    Ngày Đăng: <div class=""
                                                                                        ...
                                                                                        {{ $carbon::parse($document->created_at)->format('d-m-Y') }}
                                                    ...
                                                    "
                                                            ...
                                                            <a type="button" href="{{ $document->doc }}"
                                ...
                                @if (count($documents) < 1)
                                    <h2 class="my-5 fs-2 lh-base fw-bold" style="color:var(--c__orange) !important">Không
                                        tìm thấy
                                        kết quả</h2>
                                @endif
