...
<body>
    ...
    <a>
        <div class="container">
            ...
            <a href="{{ route('client.index') }}" class="btn   btn-block "
                style="background-color:#3a213b ;display:inline-block;
                position:fixed;top:50;left:50;transform: translate(-505,-50%);
                color:white;
