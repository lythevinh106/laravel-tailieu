                ...
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    {{-- <li class="nav-item has-submenu">
                        ...
                        <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse"
                            data-bs-target="#submenu-subject" aria-expanded="false" aria-controls="submenu-subject">
                            <span class="nav-icon">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        ...
                        <!--//nav-link-->
                        <div id="submenu-subject "
                            class="collapse submenu submenu-subject {{ $module_active == 'subject' ? 'show' : '' }}"
                            ...
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link"
                                        ...
                                        SÁCH</a></li>
                                <li class="submenu-item"><a class="submenu-link"
                                        href="{{ route('admin.category.create') }}">THÊM</a>
                                </li>
                            </ul>
                    ...
                    <li class="nav-item has-submenu">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse"
                            data-bs-target="#submenu-category" aria-expanded="false" aria-controls="submenu-category">
                            <span class="nav-icon">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div id="submenu-category"
                            class="collapse submenu submenu-category {{ $module_active == 'category' ? 'show' : '' }}"
                            data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link"
                                        href="{{ route('admin.category.index') }}">DANH
                    ...
                    <li class="nav-item has-submenu">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse"
                            data-bs-target="#submenu-document" aria-expanded="false"
                            aria-controls="submenu-document">
                            <span class="nav-icon">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="nav-link-text">TÀI LIỆU</span>
                            <span class="submenu-arrow">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <!--//nav-link-->
                        <div id="submenu-document"
                            class="collapse submenu submenu-document {{ $module_active == 'document' ? 'show' : '' }}"
                            data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link"
                                        href="{{ route('admin.document.index') }}">DANH
                                        SÁCH</a></li>
                                <li class="submenu-item"><a class="submenu-link"
                                        href="{{ route('admin.document.create') }}">THÊM</a>
                                </li>
                            </ul>
                    ...
                    <li class="nav-item has-submenu">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse"
                            data-bs-target="#submenu-exam" aria-expanded="false" aria-controls="submenu-exam">
                            <span class="nav-icon">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!--//nav-link-->
                        <div id="submenu-exam"
                            class="collapse submenu submenu-exam {{ $module_active == 'exam' ? 'show' : '' }}"
                            data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link"
                                        href="{{ route('admin.exam.index') }}">DANH
                                        SÁCH</a></li>
                                <li class="submenu-item"><a class="submenu-link"
                                        href="{{ route('admin.exam.create') }}">THÊM</a>
                                </li>
                            </ul>
